...
CELLS = [
    ...
    md(
        ...
        "Latest Unsloth keeps Colab working and manages its own torch/trl/transformers pins.",
        "The next cell **fails loudly** if a future version moves the APIs this notebook needs.",
    ),
    code(
        "%%capture",
        "!pip install -q --upgrade unsloth",
        "# Reproducible fallback — uncomment if a future Unsloth breaks this notebook:",
        '#   !pip install -q "unsloth==2025.3.19" "trl==0.11.4" "transformers==4.46.3" "peft==0.13.2"',
    ),
    code(
        "import importlib",
